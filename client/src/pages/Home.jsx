...
function Home() {
  return (
    <main className="bg-home min-h-screen w-full">
      ...
      <p className="text-white text-5xl font-title font-normal bg-secondary-color pb-5 pl-8 text-left -rotate-6 mt-20 whitespace-pre-line">
        Hello,{"\n"}Je suis Axel
      </p>
      <img
        src={Logo}
        alt="Logo"
        className="absolute top-40 right-8 rotate-[10deg] w-32 mt-5"
      />
      <p className="text-white text-5xl font-title font-normal bg-secondary-color pb-5 text-right -rotate-6 mt-8">
        Je suis DEVELOPPEUR
      </p>
